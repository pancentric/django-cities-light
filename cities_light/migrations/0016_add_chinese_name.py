...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.chinese_name'
        db.add_column(u'cities_light_country', 'chinese_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'City.chinese_name'
        db.add_column(u'cities_light_city', 'chinese_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, db_index=True),
                      keep_default=False)

        # Adding field 'Region.chinese_name'
        db.add_column(u'cities_light_region', 'chinese_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.chinese_name'
        db.delete_column(u'cities_light_country', 'chinese_name')

        # Deleting field 'City.chinese_name'
        db.delete_column(u'cities_light_city', 'chinese_name')

        # Deleting field 'Region.chinese_name'
        db.delete_column(u'cities_light_region', 'chinese_name')
